...
class TwitterHandler():
    def __init__(self):
        ...
        self.twitter = {
            ...
            'TWITTER_API_TOKEN': os.environ.get("twitter_access_token"),
            'TWITTER_API_TOKEN_SECRET': os.environ.get("twitter_access_token_secret")
        }
    ...
    def getUser(self, uid):
        try:
            ...
            print("Tweepy Error retrieving timeline: {}".format(e))
            return {'args': e.args, 'api_errors': e.api_errors, 'codes': e.api_codes, 'reason': e.response.reason}
